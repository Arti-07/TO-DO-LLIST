...
namespace TO_DO_LLIST
{
    public class DatePicker:DateTimePicker
    {
        ...
        private Image calendarIcon = Properties.Resources.icons8_календарь_48;
        ...
        {   get => skinColor; 
            set 
            {
                ...
                {
                    calendarIcon = Properties.Resources.icons8_календарь_40;
                }
                else
                    calendarIcon = Properties.Resources.icons8_календарь_48;
                this.Invalidate();
            } 
        }
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            using (StringFormat textFormat = new StringFormat()) 
            {
                ...
                RectangleF iconArea = new RectangleF(clientArea.Width - calendarIcon.Width, 
                    0, calendarIconWidth, clientArea.Height);
